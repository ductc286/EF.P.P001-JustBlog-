...
namespace IdentitySample.Models
{
    ...
    public class ApplicationUser : IdentityUser
    {
        ...
        //// Custom more field to account
        ///[Required]

        [Required]
        [Display(Name = "First Name")]
        [MaxLength(30, ErrorMessage = "Please enter a maximum of no more than 30 characters.")]
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public System.Data.Entity.DbSet<FA.JustBlog.Core.Models.Comment> Comments { get; set; }
    }
}